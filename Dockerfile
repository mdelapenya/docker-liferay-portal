...
ENV LIFERAY_TOMCAT_URL=https://sourceforge.net/projects/lportal/files/Liferay%20Portal/7.1.0%20B1/liferay-ce-portal-tomcat-7.1-b1-20180517174252853.zip/download
...
RUN mkdir -p "$LIFERAY_HOME" \
      && set -x \
      && curl -fSL "$LIFERAY_TOMCAT_URL" -o /tmp/liferay-ce-portal-tomcat-7.1-b1-20180517174252853.zip \
      && unzip /tmp/liferay-ce-portal-tomcat-7.1-b1-20180517174252853.zip -d /tmp/liferay \
      && mv /tmp/liferay/liferay-ce-portal-7.1-b1/* $LIFERAY_HOME/ \
      && rm /tmp/liferay-ce-portal-tomcat-7.1-b1-20180517174252853.zip \
      && rm -fr /tmp/liferay/liferay-ce-portal-7.1-b1 \
